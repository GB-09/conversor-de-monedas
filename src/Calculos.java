...
public class Calculos {
    ...
    ConsultaConversor conversor;

    public  Calculos(ConsultaConversor conversor){
        this.conversor = conversor;}

    public String getMonedaBase (){return monedaBase;}
    public String getMonedaObjetivo(){ return monedaObjetivo;}
    ...
    public String obtenerMensajeRespuesta(){
        String mensaje = getMonedaBase().toUpperCase() + " " + getCantidad() + " equivale a: " + getMonedaObjetivo().toUpperCase() + " " + conversor.buscaConversion(getMonedaBase(), getMonedaObjetivo(), getCantidad());
